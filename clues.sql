...
SELECT name, continent, region, population, code FROM countries
WHERE region = 'Southern Europe'
ORDER BY population;

-- Vatican City is the least populous country in southern Europe - code VAT
...
-- above query was unnecessary once 'code' was included with Clue #1 query
